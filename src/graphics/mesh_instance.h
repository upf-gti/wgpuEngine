...
public:
    ...
    void set_surface_material_type(int surface_idx, eMaterialType type);
    ...
    void set_surface_material_is_2d(int surface_idx, bool is_2d);
    ...
    void set_surface_material_override_type(int surface_idx, eMaterialType flag);
