...
void Gizmo3D::init_scale_meshes()
{
    ...
    {
        scale_sphere_mesh_x = new MeshInstance3D();
        scale_sphere_mesh_x->set_mesh(new SphereMesh());
        ...
        scale_sphere_mesh_y->set_mesh(new SphereMesh());
        Material* material_y = new Material();
        material_y->set_depth_read(false);
        material_y->set_priority(0);
        material_y->set_transparency_type(ALPHA_BLEND);
        ...
        scale_sphere_mesh_z->set_mesh(new SphereMesh());
        Material* material_z = new Material();
        material_z->set_depth_read(false);
        material_z->set_priority(0);
        material_z->set_transparency_type(ALPHA_BLEND);
...
void Gizmo3D::clean()
{
    ...
    if (scale_sphere_mesh_x) {
        delete scale_sphere_mesh_x;
    }
    if (scale_sphere_mesh_y) {
        delete scale_sphere_mesh_y;
    }
    if (scale_sphere_mesh_z) {
    ...
    if (wire_circle_mesh_y) {
        delete wire_circle_mesh_y;
    }
    if (wire_circle_mesh_z) {
    ...
    if (Input::get_trigger_value(HAND_RIGHT) > 0.5f) {
        ...
        if (free_hand_selected) {
            ...
            if (operation & ROTATE) {
                ...
                if (rotation_axis_selected.x) {
                    p1.x = p2.x = 0.0f;
                } else if (rotation_axis_selected.y) {
                    p1.y = p2.y = 0.0f;
                } else if (rotation_axis_selected.z) {
                    p1.z = p2.z = 0.0f;
                }
...
void Gizmo3D::render_xr()
{
    ...
    if (operation & TRANSLATE) {
        if (operation & TRANSLATE_X) {
            ...
            const Color& color = position_axis_selected.x ? X_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (position_axis_selected.y || position_axis_selected.z) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                               : X_AXIS_COLOR;
        ...
        if (operation & TRANSLATE_Y) {
            ...
            const Color& color = position_axis_selected.y ? Y_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (position_axis_selected.x || position_axis_selected.z) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                               : Y_AXIS_COLOR;
        ...
        if (operation & TRANSLATE_Z) {
            ...
            const Color& color = position_axis_selected.z ? Z_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (position_axis_selected.x || position_axis_selected.y) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                               : Z_AXIS_COLOR;
    ...
    if (operation & SCALE) {
        if (operation & SCALE_X) {
            ...
            const Color& color = scale_axis_selected.x ? X_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (scale_axis_selected.y || scale_axis_selected.z) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                      : X_AXIS_COLOR;
        ...
        if (operation & SCALE_Y) {
            ...
            const Color& color = scale_axis_selected.y ? Y_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (scale_axis_selected.x || scale_axis_selected.z) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                      : Y_AXIS_COLOR;
        ...
        if (operation & SCALE_Z) {
            ...
            const Color& color = scale_axis_selected.z ? Z_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (scale_axis_selected.x || scale_axis_selected.y) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                      : Z_AXIS_COLOR;
    ...
    if (operation & ROTATE) {
        if (operation & ROTATE_X) {
            ...
            const Color& color = rotation_axis_selected.x ? X_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (rotation_axis_selected.y || rotation_axis_selected.z) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                               : X_AXIS_COLOR;
        ...
        if (operation & ROTATE_Y) {
            ...
            const Color& color = rotation_axis_selected.y ? Y_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (rotation_axis_selected.x || rotation_axis_selected.z) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                               : Y_AXIS_COLOR;
        ...
        if (operation & ROTATE_Z) {
            ...
            const Color& color = rotation_axis_selected.z ? Z_AXIS_COLOR + AXIS_SELECTED_OFFSET_COLOR : (rotation_axis_selected.x || rotation_axis_selected.y) ? AXIS_NOT_SELECTED_COLOR
                                                                                                                                                               : Z_AXIS_COLOR;
