...
void Text3D::generate_mesh()
{
    ...
    material->set_shader(RenderStorage::get_singleton()->get_shader_from_source(shaders::sdf_fonts::source, shaders::sdf_fonts::path, shaders::sdf_fonts::libraries, material));
