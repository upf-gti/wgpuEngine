...
void GSNode::initialize(uint32_t splat_count)
{
    ...
    // Render
    {
        ...
        render_bindgroup = RenderAPI::get_singleton()->bind_group_create(uniforms, RendererStorage::get_shader_from_source(shaders::gs_render::source, shaders::gs_render::path, shaders::gs_render::libraries), 0);
    }
